...
# # UI
# # ------------------------------------------------------------------------------
# st.title("🏠 Housing Price Classification")
# st.write("Predict **LOW / MEDIUM / HIGH** housing price category")
...
# op = categorical["ocean_proximity"]
# default = max(op["value_counts"], key=op["value_counts"].get)

# user_input["ocean_proximity"] = st.selectbox(
#     "Ocean Proximity",
#     op["unique_values"],
#     index=op["unique_values"].index(default),
# )
